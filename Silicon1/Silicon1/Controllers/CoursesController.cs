...
public class CoursesController(HttpClient http) : Controller
{
    ...
    private string _categoryApiUrl = "https://localhost:7159/api/Categories";
    private string _courseApiUrl = "https://localhost:7159/api/Course";
    ...
    {
        var response = await _http.GetAsync($"https://localhost:7159/api/Course/{id}");
